...
p1 = 0.1 #condenser pressure (bar)
p2 = 25 #turbine bled steam pressure (bar) and pump 1 discharge pressure (bar)
p3 = 180 #feedwater pressure (bar)
p4 = 180 #main steam pressure (bar)
...
p6 = p2
print(f"Reheat Pressure: {round(float(p6),1)} bar")
s6 = s5
...
print(f"x8: {round(float(x8*100),1)} % dry")
...
plt.text(s6-.1,T6-25,f'(6)',
    ha='right',backgroundcolor='white')
plt.text(s7+.2,T7,f'(7)',
    ha='left',backgroundcolor='white')
plt.text(s8+.1,T8,f'(8)',
    ha='left',backgroundcolor='white')

plt.savefig('Plot-08.png')
